...
You have seen a few workflows in this repository. They are quality-gates to prevent duplication, control complexity and prove functionality. Do you think some of them have potential to guide code-improvements in your team? **Yes. wherever it can be used and applied.**

During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)
**Apply clean coding principles to create good code. Try to refactor legacy code in the project, only where it is necessary. It is all about maintaing a good code**
